...
import pytest
from source_cnsvs.source import CnsvsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CnsvsStream, "path", "v0/example_endpoint")
    mocker.patch.object(CnsvsStream, "primary_key", "test_primary_key")
    mocker.patch.object(CnsvsStream, "__abstractmethods__", set())
